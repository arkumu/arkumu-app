...
_TYPE_LABEL_PREDICATES: Dict[str, str] = {
    ...
    "http://arkumu.org/data/types/ereignis": "http://arkumu.org/data/properties/ereignisname",
    "http://arkumu.org/data/types/ereignistyp": "http://arkumu.org/data/properties/deutscher-name-des-ereignistyps",
