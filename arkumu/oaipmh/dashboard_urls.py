...
urlpatterns = [
    ...
    path("media-links/seed-sync/", dashboard_views.oai_media_link_seed_and_sync, name="oai_media_link_seed_and_sync"),
    path("media-links/sync-status/", dashboard_views.oai_media_sync_status, name="oai_media_sync_status"),
