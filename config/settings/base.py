...
OAI_USE_DB_ASSEMBLER = env.bool("OAI_USE_DB_ASSEMBLER", default=True)
...
OAI_ROSETTA_CURATED_PREFIXES = {
    ...
    for key, value in {
        ...
        "fuk": env("OAI_ROSETTA_CURATED_PREFIX_FUK", default="/rosetta/fudk/sandbox/input/arkumu/daten"),
        "det": env("OAI_ROSETTA_CURATED_PREFIX_DET", default="/rosetta/hfmdt/sandbox/input/arkumu/daten"),
...
PROJECT_SNAPSHOT_PROPERTY_DEBUG_ENABLED = env.bool(
